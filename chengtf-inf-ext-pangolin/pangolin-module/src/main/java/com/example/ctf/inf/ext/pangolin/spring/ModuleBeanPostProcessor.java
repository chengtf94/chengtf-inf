...
//                    log.info("初始化扩展点：{}，扩展点实现：{}", definedClass.getName(), beanName);
                    System.out.println("初始化扩展点：" + definedClass.getName() + "，扩展点实现：" + beanName);
                }
            } else {
//                log.error("初始化扩展点失败，扩展点实现：{}", beanName);
                System.out.println("初始化扩展点失败，扩展点实现：" + beanName);
            }
...
//                log.info("初始化能力：{}，能力实现：{}", definedClass.getName(), beanName);
                System.out.println("初始化能力：" + definedClass.getName() + "，能力实现：" + beanName);
            }
        }
